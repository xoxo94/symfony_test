...
{
  var $=this.$$caller, s=$.dataSource[this.sourceIndex],target,data,url,name;
  ...
  s += "<img class='ischecked' border='0' id='"+$.index +"_checkbox_"+ id +"' src='"+ 
...
{
	if($("#myconin").val()=="" || $("#myconin").val()==null || $("#myconin").val()==undefined){$("#myconin").val(",")}
	meid=$("#myconin").val()+$("#"+this.$$caller.index+"_link_"+this.index).attr("href");
	icon=$("#myconin").val()+$("#"+this.$$caller.index+"_icon_"+this.index).attr("src");
	if(meid.indexOf("meid=")>0 && icon.indexOf("file.png")>0){
	if(checked){if($("#myconin").val().indexOf(","+meid.split("meid=")[1]+",")>=0){}else{$("#myconin").val($("#myconin").val()+meid.split("meid=")[1]+",");}}else{$("#myconin").val($("#myconin").val().replace(meid.split("meid=")[1]+",",""));}
	}
